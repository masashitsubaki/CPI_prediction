...
In this code, we use the CPI dataset of human provided in "[Improving compound–protein interaction prediction by building up highly credible negative samples (Bioinformatics, 2015)](https://academic.oup.com/bioinformatics/article/31/12/i221/216307)".
